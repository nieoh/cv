...
\cventry{Feb 2017 -}{Senior Data Scientist}{Sentient Technologies}{San Francisco, CA}{}{}{}
\vspace{-.1cm}
\cvline{}
{\begin{itemize} 
	  ...
	  \item Led development of MVP for full funnel optimization. Productionize feature modeling research code. Helped develop the backend- serving using Flask, the UI with Bootstrap, and productionization with CI/CD leveraging Travis and AWS. 
	  \item Help build and evangelize an open source model management framework - Studio.ML- for data scientists and researchers.  
\end{itemize}}
\vspace{-.5cm}
...
{\begin{itemize} 
	  \item Developed a long/short trading model for a hedge fund client. Used reinforcement learning with a DQN network with experience replay and epsilon-decay in TensorFlow. 
		  Led biweekly status update meetings with the project manager and a data scientist at the hedge fund.
\end{itemize}}
\vspace{-.5cm}
...
\cvline{}
{\begin{itemize} 
	  \item Hire, train, and manage a remote group of developers working on education-focused technologies such as Wolfram|Alpha. 
	 ...
	 % \item Manage, edit and create education content such as programming challenges, Wolfram|Alpha math content, and exercises for a introductory programming book. 
	  \item Integrate Wolfram|Alpha with other classroom technologies like Google Drive.
	 %  \item Solve backend development problems such as user data management, cloud deployment and automated code-grading. 
	  \item Lead development and content meetings with CEO, Stephen Wolfram.
...
\cvline{Frameworks}{NumPy, pandas, scikit-learn, Keras, TensorFlow}
\cvline{Learning}{Machine Learning, Deep learning, Reinforcement learning, Deep Q-learning}
\cvline{Miscellaneous}{Git, AWS, Travis, Docker, HTML, \LaTeX, Camtasia, SQL}
...
\cventry{2013}{MS in Mathematics}{Purdue University}{}{}{Recipient of fellowships for outstanding PhD-track students.}%{\textit{3.6/4.0}}
...
\cvline{Interests}{Powerlifting and snowboarding.}
