...
\cvline{}
{\begin{itemize} 
	  \item Debug existing LSTM TensorFlow code for financial trading predictions.
	  \item Set up and train, using TensorFlow, a deep Q-learning network, with experience replay and epsilon-decay, a reinforcement learning model for financial synthetic trading.
	  \item Configure end points of TF model with client's computation framework for running jobs.
	  \item Contribute insight and mentoring to improve process of product development at fellowship.
	  \item Study and create blog posts about research papers pertaining to reinforcement learning.
	  \item Brain storm and create wireframes for tools for machine learning packages
\end{itemize}}
\vspace{-.5cm}
...
{\begin{itemize} 
	  ...
	  \item Integrate company's tools with existing classroom technologies, such as Wolfram|Alpha Add-on for GoogleDrive
...
\cventry{2012 - 13}{Teaching Assistant}{Purdue University}{West Lafayette, IN}{}{}
\vspace{-.1cm}
\cvline{}
{\begin{itemize} 
	\item Ran recitation sessions, quizzes and tests for various Calculus courses.
 \end{itemize}}
 \vspace{-.5cm}
...
\cvline{Deep Learning}{NumPy, pandas, scikit-learn, TensorFlow, Reinforcement Learning, Deep Q-learning, LSTM, RNN, CNN}

\cvline{Miscellaneous}{Microsoft Office, Linux, \LaTeX, Camtasia, R, Git, AWS, Containers}
